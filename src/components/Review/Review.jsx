  ...
  const reviewData = [
    {
      ...
      name: 'Abhinash Tripathy',
      review: `It's rare that you come across standout talent like Swastik Giri. 
      I had the pleasure of working with Swastik for three years at college, 
      collaborating on several project teams .
      I'm was always in awe of Swastik ability to command a room and always so passionate with his work. swastik would be an asset to any team.`
    },
    {
      // avatar: require('../../assets/avatar2.jpg'),
      name: "Lalit Kumar Soren",
      review: `It was such a pleasure to take a few classes with Swastik Giri. He was always accommodating, kind, and motivated. We worked on some projects together, and he is very applied and aims for high-quality work.
